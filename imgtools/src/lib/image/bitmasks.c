...
unsigned char mask_begin_1[BITSPERBYTE] = {
	0x00, 0x80, 0xC0, 0xE0, 0xF0, 0xF8, 0xFC, 0xFE
};

unsigned char mask_begin_0[BITSPERBYTE] = {
	0x00, 0x7F, 0x3F, 0x1F, 0x0F, 0x07, 0x03, 0x01
};

unsigned char mask_end_0[BITSPERBYTE] = {
	0x00, 0xFE, 0xFC, 0xF8, 0xF0, 0xE0, 0xC0, 0x80
};

unsigned char mask_end_1[BITSPERBYTE] = {
	0x00, 0x01, 0x03, 0x07, 0x0F, 0x1F, 0x3F, 0x7F
};


unsigned char mask_1_at[BITSPERBYTE] = {
	0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01
};

unsigned char mask_0_at[BITSPERBYTE] = {
