...
/* cfftf1.f -- translated by f2c (version of 15 October 1990  19:58:17).
...
extern /* Subroutine */ int passf(int *, int *, int *,
                           int *, int *, real *, real *,
                           real *, real *, real *, real *);
extern /* Subroutine */ int passf2(int *, int *,
                            real *, real *, real *);
extern /* Subroutine */ int passf3(int *, int *,
                            real *, real *, real *, real *);
extern /* Subroutine */ int passf4(int *, int *, real *, real *,
                            real *, real *, real *);
extern /* Subroutine */ int passf5(int *, int *,  real *, real *,
                            real *, real *, real *, real *);

/* Subroutine */ int cfftf1(int *n,
