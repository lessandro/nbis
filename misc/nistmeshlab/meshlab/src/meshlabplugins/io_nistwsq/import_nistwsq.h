...
#ifndef __VCGLIB_IMPORT_NISTWSQ
#define __VCGLIB_IMPORT_NISTWSQ
...
class ImporterNistWSQ
{
  public:
    ...
    */
    ...
    {
       int width, height, depth, ppi, lossyflag, totalSize, ret;
       unsigned char *data;
       unsigned char *idata;
       ...
       ret = wsq_decode_file(&data, &width, &height, &depth, &ppi, &lossyflag, fp);
